...
import { masterUpdateTransactionStatusAction } from "@/app/master/queue/actions";

interface Props {
  transaction: MasterTransactionDetail;
}

export function MasterTransactionView({ transaction: tx }: Props) {
            ...
            <CardContent className="text-sm">
              {lockedClerkName ? (
                <p className="text-muted-foreground">
                  Assigned to <strong className="text-foreground">{lockedClerkName}</strong>
